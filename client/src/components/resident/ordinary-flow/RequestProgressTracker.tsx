    ...
    <div className="border-b border-[#EAECF0] bg-white px-5 py-2">
      <div className="rounded-xl border border-[#E4E7EC] bg-[#FCFCFD] px-3 py-2.5">
        <div className="mb-2 flex items-center justify-end">
          {onToggleCollapsed ? (
            <button
              ...
              className="inline-flex h-6 w-6 items-center justify-center rounded-md border border-[#D0D5DD] bg-white text-[#667085] transition hover:bg-[#F9FAFB]"
              aria-label={collapsed ? "Show progress status" : "Hide progress status"}
            >
        ...
        {!collapsed ? (
          ...
          <div className="rounded-lg border border-[#EAECF0] bg-white px-3 py-2 text-center text-[12px] font-medium text-[#667085]">
            Progress hidden. Current stage:{" "}
            <span className="font-semibold text-[#101828]">{steps[currentIndex]}</span>
          </div>
        )}
      </div>
    </div>
